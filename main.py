...
Examples:
  ...
  python main.py --stats              Show database statistics
    ...
    parser.add_argument(
        "--run-once", action="store_true", help="Run the full pipeline once"
    )
    parser.add_argument(
        "--schedule", action="store_true", help="Run the pipeline on a schedule"
    )
    parser.add_argument(
        "--sync", action="store_true", help="Sync messages from Telegram only"
    )
    parser.add_argument(
        "--classify", action="store_true", help="Classify messages only"
    )
    parser.add_argument("--publish", action="store_true", help="Publish messages only")
